...
Color colorStart = new Color(25, 255, 255, 0);
Color colorEnd   = new Color(100, 209, 71, 255);
...
public override void SetDefaults()
{
    ...
    Projectile.timeLeft = (int)(Projectile.timeLeft * 0.25f * 0.03f);
...
public override void AI()
{
    ...
    float progress = MathHelper.Clamp(age /(50f*0.4f), 0f, 1f);
    float scale = MathHelper.Clamp((float)(progress * 2f), 0, 1f);
    Color drawColor  = Color.Lerp(colorStart, colorEnd, progress);
