            ...
            */
            if (bouttaBlowUp > 200)
            {
                ...
                for (int i = 0; i < shrapnelCount; i++)
                {
                    ...
                    float speedY = Main.rand.NextFloat(-10f, -2f);
        
                    Vector2 randomVelocity = new Vector2(speedX, speedY);

                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, randomVelocity, ModContent.ProjectileType<GrenadeShrapnel>(), 25, 5, -1);
                }
            }
        ...
        public void stateHandler()
        {
            ...
            if (state == 1)
            {
                ...
                if (timere == 12)
                {
                    ...
                    Gore pinGore = Gore.NewGoreDirect(Projectile.GetSource_FromAI(), Projectile.Center, new Vector2(0, 2), pin, 1);
                    pinGore.timeLeft = 0;
                }
